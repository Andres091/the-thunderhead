...
module.exports.run = async (client, message, args) => {
  ...
  var url = "https://www.youtube.com/watch?v=BYN-OEcD-3w"
...
module.exports.config = {
  ...
  aliases: [],
  use: "bigchungus",
  description: "yo wtf? based (bigchungus (will positivley change the scale of a chungus moment that being from small to large (big if you will)))",
  state : "gamma",
  page: -1
};
